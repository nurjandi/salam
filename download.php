...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="assets/css/fontawesome.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
  ...
  <div class="row bg-white border-bottom" style=" height: 100px; padding: 20px;">
    <div class="offset-md-1 col-md-6 col-xs-12">
      ...
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="inlineRadio2">Berkas Dosen</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3">
        <label class="form-check-label" for="inlineRadio3">Berkas Mahasiswa</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="option3">
        <label class="form-check-label" for="inlineRadio4">Berkas Administrasi</label>
      </div>
    </div>
  ...
  <div class="row bg-white" style="padding-top: 64px;">
    <div class="offset-md-2 col-md-9 bg-white border" style="height: auto; margin-bottom: 48px;">
      <h5 style="padding: 16px;">Download</h5>
      <div class="row border-top" style="padding: 16px;">
        <div class="col-md-2 col-xs-12" style="padding: 36px;">
          <i class="fas fa-copy fa-3x" aria-hidden="true"></i>
        </div>
        <div class="col-md-7 col-xs-12" style="padding: 16px;">
          <h5>Dokumen Pendaftaran KP</h5>
          <h6>uploaded: 26 feb 2018</h6>
        </div>
        <div class="col-md-2 col-xs-12" style="padding: 16px;">
